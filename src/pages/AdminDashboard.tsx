    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="w-64 bg-white border-r border-gray-200 p-6 fixed h-full hidden md:block flex flex-col overflow-y-auto">
        ...
        <nav className="space-y-2">
          ...
          <Link to="/admin/verifications" className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-gray-100 transition">
            <VerificationsIcon />
            Verifications
          </Link>
      ...
      <div className={`fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 z-50 transform transition-transform duration-300 md:hidden overflow-y-auto ${
        ...
        <div className="p-6 h-full flex flex-col">
          ...
          <nav className="space-y-2 flex-1">
            ...
            <Link to="/admin/verifications" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-600 hover:bg-gray-100 transition">
              <VerificationsIcon />
              Verifications
            </Link>
