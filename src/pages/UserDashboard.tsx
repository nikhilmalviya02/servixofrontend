        ...
        <div className="grid gap-6">
          {bookings.map((b) => (
            ...
            >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-800">{b.timeSlot}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-800 truncate max-w-[150px]">{b.address?.street}, {b.address?.city}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {(b.status === "pending" || b.status === "accepted") && (
                <div className="flex flex-wrap gap-3 mt-5">
                  <button
                    ...
                    text-red-600 px-4 py-2.5 rounded-xl 
                  ...
                  <button
                    ...
                    text-amber-600 px-4 py-2.5 rounded-xl 
              ...
              {/* RESCHEDULE FORM */}
              {rescheduleId === b._id && (
                <div className="mt-5 pt-5 border-t border-gray-200 bg-blue-50 rounded-xl p-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="date"
                        className="w-full border border-gray-300 p-3 rounded-xl bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                        value={newDate}
                    ...
                    <div>
                      <label className="block text-xs font-medium text-gray-600 mb-1.5">New Time Slot</label>
                      <select
                        className="w-full border border-gray-300 p-3 rounded-xl bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                        value={newSlot}
                  ...
                  <div className="flex gap-3 mt-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 text-gray-700 px-5 py-2.5 rounded-xl"
                    >
                      Cancel
                    </button>
                  </div>
              ...
              {/* REPEAT BOOKING */}
              {b.status === "completed" && (
                <button className="mt-5 flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
